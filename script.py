__author__="Alex Ilcheko"
# --- original script author's comments.
## --- Alex Ilchenko's comments.  

'''Leakage fill code written by AlexIlcheko and referenced by JacobHsiao in MLND Capstone Project'''
...
if __name__ == '__main__':
    ...
    HEADER='/Users/jhsiao/Downloads/MLND/'    
    ppl = pd.read_csv('/Users/jhsiao/Downloads/MLND/people.csv')
    ...
    # Load activities.--------------------------------------------------------------
    # Read and combine.
    activs = pd.read_csv(HEADER+'act_train.csv')
    TestActivs = pd.read_csv(HEADER+'act_test.csv')
    ...
    testsetdt.to_csv(HEADER+'Submission_testsetdt.csv', index=False)
